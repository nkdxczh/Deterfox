...
public:
  ...
  //_MODIFY Sat 22 Oct 2016 03:05:10 PM EDT START
  bool getIsMain() {
    return mIsMain;
  }
  ...
  //_MODIFY Sat 22 Oct 2016 03:06:43 PM EDT END

  //_MODIFY Tue 18 Oct 2016 11:19:12 AM EDT START
  ...
  //_MODIFY Tue 18 Oct 2016 11:20:10 AM EDT END
...
private:
  ...
  //_MODIFY Sat 22 Oct 2016 03:06:53 PM EDT START
  bool mIsMain = false;
  //_MODIFY Sat 22 Oct 2016 03:06:55 PM EDT END

  //_MODIFY Tue 18 Oct 2016 11:23:11 AM EDT START
    ...
    while(head != mTail || offset != mOffsetTail) {
      ...
      if(offset == EVENTS_PER_PAGE) {
        ...
        if(head->mExpTime[offset] == expTime) {
          //_MODIFY Sun 23 Oct 2016 04:41:10 PM EDT START
          head->mExpTime[offset] = (expTime >> 1 << 1);
          //head->mExpTime[offset] = (expTime >> 1 << 1 | flag);
          //_MODIFY Sun 23 Oct 2016 04:41:13 PM EDT END
  ...
  //_MODIFY Tue 18 Oct 2016 11:39:38 AM EDT END

//_MODIFY Thu 13 Oct 2016 02:55:25 PM EDT START
  ...
  //_MODIFY Thu 13 Oct 2016 02:55:29 PM EDT END
  ...
  {
    struct Page* mNext;
    //_MODIFY Mon 17 Oct 2016 07:13:40 PM EDT START
    //bool flag[EVENTS_PER_PAGE + 1];
    uint64_t mExpTime[EVENTS_PER_PAGE + 1];
    //_MODIFY Mon 17 Oct 2016 07:13:43 PM EDT END
